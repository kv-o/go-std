// Package go-std collects implements an alternative standard library.
//
...
// distribution. Package go-std attempts to resolve this issue by providing a
// set of useful identifiers for general programming.
package std
